...
const AboutRoute: React.FC<Props> = (props) => {
  ...
  return (
    ...
    >
      ...
      >
        <img
          style={belowSm ? belowSmAvatarSize : aboveSmAvatarSize}
      ...
      <Grid item container direction="column">
        <ListTitle
          title="About me"
          fontStyle={{ fontSize: 20, fontWeight: "bold", color: "#212121" }}
        />
        <Typography className={classes.text}>{GlobalVars.myDetails}</Typography>
      </Grid>
    </Grid>
  );
};
