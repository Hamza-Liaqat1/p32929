...
const TopRightButtons: React.FC<Props> = (props) => {
  ...
  return (
    <Grid container direction="row" justify="flex-end" item xs={4}>
      {/*
      ...
      <IconButton
        size="small"
        target="_blank"
        href="https://github.com/p32929/p32929.github.io/"
      >
        <SvgHelper styles={{ padding: 8 }} path={OurIcons.fork} size={20} />
      </IconButton>
      ...
      >
        <SvgHelper styles={{ padding: 8 }} path={OurIcons.palette} size={20} />
      </IconButton>
    </Grid>
  );
};
